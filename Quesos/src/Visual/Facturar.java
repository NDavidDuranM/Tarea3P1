...
*/
	...
	public Facturar(ComplejoDeQueso complejo) {
		...
		Factura helper=new Factura(Integer.toString(n), null, 0, 0);
		setTitle("Facturar");
		...
		btnSeleccionar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				int auxrow=TablaQueso.getSelectedRow();
				int auxcolum=TablaQueso.getSelectedColumn();
				
				helper.getQuesos().add(complejo.BuscarQuesoBycode(TablaQueso.getModel().getValueAt(auxrow, 0).toString()));
