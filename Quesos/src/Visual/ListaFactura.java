...
*/
	...
	public ListaFactura(ComplejoDeQueso complejo) {
		...
		for(int i =0; i<complejo.getCantfactura();i++,auxcountFactura++) {
			...
			FacturaHelper[auxcountFactura][1]=complejo.getFacturas().get(i).getCodigo();
			FacturaHelper[auxcountFactura][2]=complejo.getFacturas().get(i).getPreciofacturado();
			FacturaHelper[auxcountFactura][3]=complejo.getFacturas().get(i).getCliente().getNombre();
			FacturaHelper[auxcountFactura][4]=complejo.getFacturas().get(i).getCantqueso();
